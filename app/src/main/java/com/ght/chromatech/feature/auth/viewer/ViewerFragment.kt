package com.ght.chromatech.feature.auth.viewer
...
class ViewerFragment : AppFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_share_your_viewer,container,false)
    }
